...
%	{\textcolor{stockholmBlue}{x} 	&&	\textcolor{stockholmPink}{m} &	\textcolor{stockholmPink}{m}\textcolor{stockholmBlue}{x} \\
%	 \textcolor{stockholmBlue}{x}	&&	\textcolor{stockholmPink}{m}  & \textcolor{stockholmPink}{m}\textcolor{stockholmBlue}{x} \\
%	 \underbrace{\textcolor{stockholmBlue}{x \cdot x}}_{\text{1st Term}} && \underbrace{\textcolor{stockholmPink}{k}}_{\text{Last Term}} & \underbrace{\dfrac{b}{a}x}_{\text{Middle Terms}}\\};
...
%	\matrix (m) [matrix of math nodes, row sep=3em,
%	column sep=2.5em, text height=1.5ex, text depth=0.25ex]
%	{\textcolor{stockholmBlue}{x} 	&&	\textcolor{stockholmPink}{m} &	\dfrac{b}{2a} \cdot x   \\
%	 \textcolor{stockholmBlue}{x}	&&	\textcolor{stockholmPink}{m}  &  \dfrac{b}{2a} \cdot x  \\
%	 \underbrace{\textcolor{stockholmBlue}{x \cdot x}}_{\text{1st Term}} && \underbrace{\textcolor{stockholmPink}{k}}_{\text{Last Term}} & \underbrace{\dfrac{b}{a} x}_{\text{Middle Terms}}\\};
%	\path[->, font=\scriptsize]
...
%	\matrix (m) [matrix of math nodes, row sep=3em,
%	column sep=2.5em, text height=1.5ex, text depth=0.25ex]
%	{\textcolor{stockholmBlue}{x} 	&&	\textcolor{stockholmPink}{b/2a}	& x \cdot b/2a \\
%	 \textcolor{stockholmBlue}{x}	&&	\textcolor{stockholmPink}{b/2a}  & x \cdot b/2a\\
%	 \underbrace{\textcolor{stockholmBlue}{x \cdot x}}_{\text{1st Term}} && \underbrace{\textcolor{stockholmPink}{(b/2a)^2}}_{\text{Last Term}} & %\underbrace{bx/a}_{\text{Middle Terms}}\\};
%	\path[->, font=\scriptsize]
%	(m-1-1) 	edge node[description] {$\times$} (m-2-3)
%			edge  node[description] {$\times$} (m-2-1)
%	(m-2-1)	edge  node[description] {$\times$} (m-1-3)
