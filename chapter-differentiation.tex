...
\begin{tikzpicture}
	\begin{axis}[
          ...
          \addplot [stockholmPink!15, domain=(0:2)] {-3.348+4.348*x};
          \addplot [stockholmPink!32, domain=(0:2)] {-2.704+3.704*x};
          \addplot [stockholmPink!49, domain=(0:2)] {-1.994+2.994*x};         
          \addplot [stockholmPink!66, domain=(0:2)] {-1.326+2.326*x}; 
          \addplot [stockholmPink!83, domain=(0:2)] {-0.666+1.666*x};
	  \addplot [stockholmDarkGrey,dashed] plot coordinates {(1,0) (1,1)};
          \addplot [stockholmDarkGrey,dashed] plot coordinates {(0,1) (1,1)};
          \addplot [stockholmDarkGrey,dashed] plot coordinates {(0,3) (1.666,3)};
          \addplot [stockholmDarkGrey,dashed] plot coordinates {(1.666,0) (1.666,3)};
          \addplot [very thick,stockholmBlue, smooth,domain=(0:1.833)] {-1/(x-2)};
          \addplot[color=stockholmDarkGrey,fill=stockholmDarkGrey,only marks,mark=*] coordinates{(1.666,3)};  %% closed hole          
          \addplot[color=stockholmDarkGrey,fill=stockholmDarkGrey,only marks,mark=*] coordinates{(1,1)};  %% closed hole          
          \addplot [very thick,stockholmPink, smooth,domain=(0:2)] {x};
        \end{axis}
\end{tikzpicture}
