...
%-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
%	SECTION: Simplifying Degree 1 Univariate Polynomials
%-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=

\section{Simplifying Degree 1 Univariate Polynomials}\label{Simplifying Degree 1 Univariate Polynomials}
...
%-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
%	SECTION: Simplifying Degree 2 Univariate Polynomials
%-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=

\section{Simplifying Degree 2 Univariate Polynomials}\label{Simplifying Degree 2 Univariate Polynomials}
